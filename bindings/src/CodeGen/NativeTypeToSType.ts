...
export type STypeStringSimple = "SNormalObject<any>" | "SValue<any>" | "SBooleanValue<any, boolean>" | "SUndefinedValue<any>" | "SBooleanValue<any, number>" | "SNumberValue<any, number>" | "SObjectValue<any, any, any>" | "SFunction<any>" | "SNullValue<any>" | "SStringValue<any, string>" | "SSymbolValue<any, symbol>";
